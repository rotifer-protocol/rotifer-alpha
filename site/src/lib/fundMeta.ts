...
export const PERSONALITY_IDS = ["turtle", "cheetah", "octopus", "shark", "honey_badger"] as const;
...
const PERSONALITY_GRADIENTS: Record<string, string> = {
  ...
  honey_badger: "from-pink-500/6 to-transparent",
};
...
const PERSONALITY_BORDER_COLORS: Record<string, string> = {
  ...
  honey_badger: "border-l-pink-500/50",
};
