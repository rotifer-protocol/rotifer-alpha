...
const en = {
  ...
  phase1ConsecDaysLabel: "Days Met",
  phase1ConsecDaysTip: "Consecutive days with fill rate ≥85%. Both metrics must hold together for 14 days.",
  ...
  phase1TargetNote: "Exit → Phase 2 (Live Small): 14 consecutive days with fill rate ≥85% AND price deviation ≤5%",
...
const zh: Record<TranslationKey, string> = {
  ...
  phase1ConsecDaysLabel: "已达标天数",
  phase1ConsecDaysTip: "连续满足成交率 ≥85% 的天数。两项指标需同时满足。",
  ...
  phase1TargetNote: "解锁 Phase 2 条件：连续 14 天成交率 ≥85% 且价格偏差 ≤5%",
